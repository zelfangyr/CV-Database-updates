...
**v1.4.2** — Bug fix: UnicodeEncodeError ('charmap' codec) saat upload PDF yang berisi karakter unicode tertentu (mis. bullet '▪'), karena konsol Windows default pakai encoding cp1252. Paksa stdout/stderr ke UTF-8.

### Riwayat versi
- **1.4.2** — Bug fix: UnicodeEncodeError saat upload PDF berisi karakter unicode tertentu (mis. bullet '▪') di konsol Windows.
